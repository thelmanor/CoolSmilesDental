    ...
    <head>
        ...
        <title> Profile Page</title>
         <% 
            ...
            System.out.println("In UpdateProfileJSP==================================");
            p1.display();
        %>
        <style>
        body {
    ...
    <body>
        <form action="PUpdateServlet" method="post">
            ...
            <div class="container">
                ...
                <input type="text" name="first" value="<%=p1.getFirstName()%>">

                <label ><b>Last Name</b></label>
                <input type="text" name="last" value="<%=p1.getLastName()%>">

                <label ><b> Address</b></label>
                <input type="text" name="addr" value="<%=p1.getAddress()%>">

                <label ><b>Email</b></label>
                <input type="text" name="email" value="<%=p1.getEmail()%>">

                <label><b>Password</b></label>
                <input type="text" name="pw" value="<%=p1.getPassword()%>">

                <label ><b>Insurance</b></label>
                <input type="text" name="insCo" value="<%=p1.getInsurance()%>">
